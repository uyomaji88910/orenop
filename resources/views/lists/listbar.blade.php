...
<ul class="nav nav-tabs">
 <li role="presentation" class="{{ Request::is('lists/absent') ? 'tab-col' : 'active' }} tabs"><a href="{{ route('lists.absent') }}">Absents <span class="badge"> {{$count['count_absent']}}</span></a></li>
 ...
 <li role="presentation" class="{{ Request::is('lists/paid') ? 'tab-col' : 'active' }}"><a href="{{ route('lists.paid') }}"> Paid Holiday <span class="badge badge-light"> {{$count['count_paid']}}</span></a></li> 
</ul>
